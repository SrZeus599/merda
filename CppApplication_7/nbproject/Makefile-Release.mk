...
.NO_PARALLEL:${OBJECTDIR}/Parte\ 5\ ex\ 6.o
${OBJECTDIR}/Parte\ 5\ ex\ 6.o: Parte\ 5\ ex\ 6.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Parte\ 5\ ex\ 6.o Parte\ 5\ ex\ 6.c
