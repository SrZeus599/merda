...
${OBJECTDIR}/_ext/c0d0437b/API_Leitura.o: ../../API_Leitura/API_Leitura.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/c0d0437b/API_Leitura.o ../../API_Leitura/API_Leitura.c

${OBJECTDIR}/_ext/c0d0437b/API_Utils.o: ../../API_Leitura/API_Utils.c
	${MKDIR} -p ${OBJECTDIR}/_ext/c0d0437b
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/c0d0437b/API_Utils.o ../../API_Leitura/API_Utils.c

${OBJECTDIR}/Estruturas_gerais.o: Estruturas_gerais.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Estruturas_gerais.o Estruturas_gerais.c

${OBJECTDIR}/Gestao_Faturas.o: Gestao_Faturas.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gestao_Faturas.o Gestao_Faturas.c

${OBJECTDIR}/Gestao_Precos.o: Gestao_Precos.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gestao_Precos.o Gestao_Precos.c

${OBJECTDIR}/Gestao_Utilizadores.o: Gestao_Utilizadores.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gestao_Utilizadores.o Gestao_Utilizadores.c

${OBJECTDIR}/Gestao_Viagens.o: Gestao_Viagens.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gestao_Viagens.o Gestao_Viagens.c
...
${OBJECTDIR}/Persistencia_Dados.o: Persistencia_Dados.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Persistencia_Dados.o Persistencia_Dados.c
